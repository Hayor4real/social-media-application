...
import Dropzone from "react-dropzone"; // user can put image so they can upload
import FlexBetween from "components/FlexBetween";
// this will determine how form library will save this information
...
}); // to make sure the user doesnt put something incorrect
      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          <Box
            display="grid"
            gap="30px"
            gridTemplateColumns="repeat(4, minmax(0, 1fr))" // split the grid into 4 sections
            sx={{
          ...
          >
            {isRegister && (
              <>
                ...
                <Box
                  gridColumn="span 4"
                  border={`1px solid ${palette.neutral.medium}`} //short hand for borders
                  borderRadius="5px"
                  p="1rem"
                >
                  <Dropzone
