...
const Navbar = () => {
  ...
  // easy way to use media query in react
  const theme = useTheme(); // determines the color based on a particular mode
  ...
  return (
    <FlexBetween padding="1rem 6%" backgroundColor={alt}>
        ...
        <Typography
          ...
          sx={{
            "&:hover": {
              color: primaryLight,
              cursor: "pointer",
            }, // you can pass css properties in situation where you has pseudo props
          }}
        >
          Application Media
        </Typography>
      ...
      {/* DESKTOP NAV using redux to flip the light and dark mode */}
      {isNonMobileScreens ? (
